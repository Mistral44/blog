<?php
/**
 * Widget API: Wpajax_Widget_Subscribe
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Wpajax_Widget_Subscribe extends WP_Widget {
	/**
	...
	public function __construct() {
		...
		parent::__construct( 'subscribe', esc_html__( 'Subscribe form' ), $widget_ops, $control_ops );
	}
	/**
